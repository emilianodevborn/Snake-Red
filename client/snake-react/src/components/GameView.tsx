...
import { GameState, CANVAS_WIDTH, CANVAS_HEIGHT, GRID_SIZE } from "../game/GameTypes";
...
const initialGameState: GameState = {
    snakes: [
        { id: "host", segments: [{ x: 5, y: 5 }], direction: { x: 1, y: 0 }, color: "green" },
        ...
        const handleInput = (event: MessageEvent) => {
            getMessageText(event.data)
                .then((text) => {
                    ...
                    if (data.type === "input") {
                        console.log("Host recibe input:", data);
